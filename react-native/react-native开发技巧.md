...
![图片](https://uploader.shimo.im/f/Nnn5ICLAd8N5246G.png!thumbnail?fileGuid=Jw6k6vTD36tRXCyW)

在开发选项中就可以看到模拟器的运行，如果有网页，会显示网页的地址，点击即可查看

![图片](https://uploader.shimo.im/f/MzZlnrmQbGVaBvQz.png!thumbnail?fileGuid=Jw6k6vTD36tRXCyW)
...
chrome://inspect
```
![图片](https://uploader.shimo.im/f/6WvjXOSsrSZMVMQA.png!thumbnail?fileGuid=Jw6k6vTD36tRXCyW)
...
![图片](https://uploader.shimo.im/f/1dLdo3KEEiSUMqwk.png!thumbnail?fileGuid=Jw6k6vTD36tRXCyW)
